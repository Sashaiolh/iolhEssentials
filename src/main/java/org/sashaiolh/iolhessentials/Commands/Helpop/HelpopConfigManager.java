...
public class HelpopConfigManager {
    private static String CONFIG_PATH = "";
    private static Properties properties;

    public HelpopConfigManager(String path) {
        CONFIG_PATH = path;
    ...
    private static void createDefaultConfig() {
        ...
        properties.setProperty("defaultColor", "6");
        properties.setProperty("admin", "4");
        properties.setProperty("techadmin", "c");
        properties.setProperty("dev", "5");
